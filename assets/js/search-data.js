...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
  ...
  },{id: "nav-research-work",
          title: "research work",
          description: "Highlighted Project",
          section: "Navigation",
          handler: () => {
            window.location.href = "/research_work/";
          },
        },{id: "nav-writing",
          title: "writing",
          description: "",
        ...
        },{id: "post-useful-blog-posts",
        
          title: "Useful Blog Posts",
        
        description: "A short summary of this blog post",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2026/useful_blog/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_Swapnil_Saha.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%77%61%70%6E%69%6C.%73%61%68%61@%72%75%74%67%65%72%73.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=https://scholar.google.com/citations?hl=en&user=L95lKE8AAAAJ&view_op=list_works&sortby=pubdate", "_blank");
        },
      },{
      id: 'light-theme',
